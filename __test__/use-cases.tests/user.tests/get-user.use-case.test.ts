...
/**
 * Test suite for the GetUser use case.
 * This test covers the initialization and behavior of the GetUser class.
...
describe('GetUser', () => {
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockUserService.getUser.mockResolvedValue(mockUserDTO);
