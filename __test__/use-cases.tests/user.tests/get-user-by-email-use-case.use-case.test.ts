...
import { GetUserByEmailUseCase } from '../../../src/application/use-cases/user.use-cases/get-user-by-email-use-case.use-case';
import { UserDTO } from '../../../src/presentation/dtos/user.dto';
import { toUserDTO } from '../../../src/application/helper/to-dto/to.address.dto';

/**
 * Test suite for the GetUserByEmailUseCase use case.
 * This test covers the initialization and behavior of the GetUserByEmailUseCase class.
...
describe('GetUserByEmailUseCase', () => {
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockUserService.getUserByEmailUseCase.mockResolvedValue(mockUserDTO);
    ...
    expect(mockUserService.getUserByEmailUseCase).toHaveBeenCalledWith(email);
