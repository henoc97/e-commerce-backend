...
import { UpdateUserPasswordUseCase } from '../../../src/application/use-cases/user.use-cases/update-user-password-use-case.use-case';
import { UserDTO } from '../../../src/presentation/dtos/user.dto';
import { toUserDTO } from '../../../src/application/helper/to-dto/to.address.dto';

/**
 * Test suite for the UpdateUserPasswordUseCase use case.
 * This test covers the initialization and behavior of the UpdateUserPasswordUseCase class.
...
describe('UpdateUserPasswordUseCase', () => {
  ...
  const mockUserService = {
    updateUserPasswordUseCase: jest.fn(),
  };
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockUserService.updateUserPasswordUseCase.mockResolvedValue(mockUserDTO);
