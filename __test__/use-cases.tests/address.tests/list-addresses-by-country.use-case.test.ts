...
/**
 * Test suite for the ListAddressesByCountry use case.
 * This test covers the initialization and behavior of the ListAddressesByCountry class.
 * It mocks the AddressService service and verifies that the use case handles the business logic as expected.
 */
describe('ListAddressesByCountry', () => {
  ...
  const mockAddressService = {
    listAddressesByCountry: jest.fn(),
  };
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockAddressService.listAddressesByCountry.mockResolvedValue(mockAddressDTO);
