...
describe('ModifyAddressById', () => {
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockAddressService.modifyAddressById.mockResolvedValue(mockAddressDTO);
