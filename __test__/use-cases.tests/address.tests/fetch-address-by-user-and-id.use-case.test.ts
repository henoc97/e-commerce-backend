...
import { FetchAddressByUserAndId } from '../../../src/application/use-cases/address.use-cases/fetch-address-by-user-and-id.use-case';
...
/**
 * Test suite for the FetchAddressByUserAndId use case.
 * This test covers the initialization and behavior of the FetchAddressByUserAndId class.
 * It mocks the AddressService service and verifies that the use case handles the business logic as expected.
 */
describe('FetchAddressByUserAndId', () => {
  let fetchAddressByUserAndId: FetchAddressByUserAndId;
  let addressService: AddressService;

  // Mock implementation of the AddressService service with jest functions
  const mockAddressService = {
    fetchAddressByUserAndId: jest.fn(),
  };
