...
/**
 * Test suite for the FetchCartItemByProductAndCart use case.
 * This test covers the initialization and behavior of the FetchCartItemByProductAndCart class.
 * It mocks the CartItemService service and verifies that the use case handles the business logic as expected.
 */
describe('FetchCartItemByProductAndCart', () => {
  let fetchCartItemByProductAndCart: FetchCartItemByProductAndCart;
  let cartItemService: CartItemService;

  // Mock implementation of the CartItemService service with jest functions
  const mockCartItemService = {
    fetchCartItemByProductAndCart: jest.fn(),
  };
