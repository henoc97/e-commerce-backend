...
/**
 * Test suite for the FetchHighestQuantityItem use case.
 * This test covers the initialization and behavior of the FetchHighestQuantityItem class.
 * It mocks the CartItemService service and verifies that the use case handles the business logic as expected.
 */
describe('FetchHighestQuantityItem', () => {
  let fetchHighestQuantityItem: FetchHighestQuantityItem;
  let cartItemService: CartItemService;

  // Mock implementation of the CartItemService service with jest functions
  const mockCartItemService = {
    fetchHighestQuantityItem: jest.fn(),
  };
