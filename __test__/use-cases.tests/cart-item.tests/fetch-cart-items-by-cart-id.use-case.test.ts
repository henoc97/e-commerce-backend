...
/**
 * Test suite for the FetchCartItemsByCartId use case.
 * This test covers the initialization and behavior of the FetchCartItemsByCartId class.
 * It mocks the CartItemService service and verifies that the use case handles the business logic as expected.
 */
describe('FetchCartItemsByCartId', () => {
  let fetchCartItemsByCartId: FetchCartItemsByCartId;
  let cartItemService: CartItemService;

  // Mock implementation of the CartItemService service with jest functions
  const mockCartItemService = {
    fetchCartItemsByCartId: jest.fn(),
  };
