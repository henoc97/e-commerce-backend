...
/**
 * Test suite for the CountTotalNewsletterSubscriptions use case.
 * This test covers the initialization and behavior of the CountTotalNewsletterSubscriptions class.
 * It mocks the NewsletterSubscriptionService service and verifies that the use case handles the business logic as expected.
 */
describe('CountTotalNewsletterSubscriptions', () => {
  let countTotalNewsletterSubscriptions: CountTotalNewsletterSubscriptions;
  ...
  const mockNewsletterSubscriptionService = {
    countTotalNewsletterSubscriptions: jest.fn(),
  };
