...
/**
 * Test suite for the UpdateProductImage use case.
 * This test covers the initialization and behavior of the UpdateProductImage class.
...
describe('UpdateProductImage', () => {
  ...
  beforeEach(async () => {
    ...
    updateProductImage = module.get<UpdateProductImage>(UpdateProductImage);
