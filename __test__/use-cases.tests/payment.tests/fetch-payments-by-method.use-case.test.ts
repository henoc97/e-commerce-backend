...
/**
 * Test suite for the FetchPaymentsByMethod use case.
 * This test covers the initialization and behavior of the FetchPaymentsByMethod class.
...
describe('FetchPaymentsByMethod', () => {
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockPaymentService.fetchPaymentsByMethod.mockResolvedValue(mockPaymentDTO);
