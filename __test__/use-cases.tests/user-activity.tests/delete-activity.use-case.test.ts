...
/**
 * Test suite for the DeleteActivity use case.
 * This test covers the initialization and behavior of the DeleteActivity class.
...
describe('DeleteActivity', () => {
  ...
  beforeEach(async () => {
    ...
    deleteActivity = module.get<DeleteActivity>(DeleteActivity);
  ...
  it('should create and return an address DTO', async () => {
    ...
    expect(mockUserActivityService.deleteActivity).toHaveBeenCalledWith(id);
