...
describe('FetchUserProfileByUserId', () => {
  ...
  beforeEach(async () => {
    ...
    fetchUserProfileByUserId = module.get<FetchUserProfileByUserId>(FetchUserProfileByUserId);
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockUserProfileService.fetchUserProfileByUserId.mockResolvedValue(mockUserProfileDTO);
    ...
    expect(mockUserProfileService.fetchUserProfileByUserId).toHaveBeenCalledWith(userId);
  ...
  it('should throw an error when fetchUserProfileByUserId execute method fails', async () => {
    ...
    mockUserProfileService.fetchUserProfileByUserId.mockRejectedValue("Service method error");

    // Verify that the use case throws an error when service method fails
    await expect(fetchUserProfileByUserId.execute(userId)).rejects.toThrow('Service method error');
  });
});
