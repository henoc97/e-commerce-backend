...
/**
 * Test suite for the DeleteUserProfile use case.
 * This test covers the initialization and behavior of the DeleteUserProfile class.
...
describe('DeleteUserProfile', () => {
  ...
  beforeEach(async () => {
    ...
    deleteUserProfile = module.get<DeleteUserProfile>(DeleteUserProfile);
  ...
  it('should create and return an address DTO', async () => {
    ...
    const result = await deleteUserProfile.execute(id);

    // Verify that the service was called with the expected arguments
    expect(mockUserProfileService.deleteUserProfile).toHaveBeenCalledWith(id);
