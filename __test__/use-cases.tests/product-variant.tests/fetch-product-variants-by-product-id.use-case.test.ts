...
describe('FetchProductVariantsByProductId', () => {
  ...
  beforeEach(async () => {
    ...
    fetchProductVariantsByProductId =
      module.get<FetchProductVariantsByProductId>(
        FetchProductVariantsByProductId,
      );
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockProductVariantService.fetchProductVariantsByProductId.mockResolvedValue(
    ...
    expect(
      mockProductVariantService.fetchProductVariantsByProductId,
  ...
  it('should throw an error when fetchProductVariantsByProductId execute method fails', async () => {
    ...
    mockProductVariantService.fetchProductVariantsByProductId.mockRejectedValue(
      'Service method error',
    );

    // Verify that the use case throws an error when service method fails
    await expect(
      fetchProductVariantsByProductId.execute(productId),
