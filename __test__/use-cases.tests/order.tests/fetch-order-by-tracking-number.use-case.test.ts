...
/**
 * Test suite for the FetchOrderByTrackingNumber use case.
 * This test covers the initialization and behavior of the FetchOrderByTrackingNumber class.
 * It mocks the OrderService service and verifies that the use case handles the business logic as expected.
 */
describe('FetchOrderByTrackingNumber', () => {
  let fetchOrderByTrackingNumber: FetchOrderByTrackingNumber;
  let orderService: OrderService;

  // Mock implementation of the OrderService service with jest functions
  const mockOrderService = {
    fetchOrderByTrackingNumber: jest.fn(),
  };
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockOrderService.fetchOrderByTrackingNumber.mockResolvedValue(mockOrderDTO);
