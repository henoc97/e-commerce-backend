...
/**
 * Test suite for the DeleteOrder use case.
 * This test covers the initialization and behavior of the DeleteOrder class.
...
describe('DeleteOrder', () => {
  ...
  beforeEach(async () => {
    ...
    deleteOrder = module.get<DeleteOrder>(DeleteOrder);
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockOrderService.deleteOrder.mockResolvedValue(mockOrderDTO);
   ...
   */
  it('should throw an error when deleteOrder execute method fails', async () => {
    // Simulate a failure when calling the service method
    mockOrderService.deleteOrder.mockRejectedValue("Service method error");

    // Verify that the use case throws an error when service method fails
    await expect(deleteOrder.execute(id)).rejects.toThrow('Service method error');
  });
});
