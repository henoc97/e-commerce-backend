...
/**
 * Test suite for the AddImageToProduct use case.
 * This test covers the initialization and behavior of the AddImageToProduct class.
...
describe('AddImageToProduct', () => {
  let addImageToProduct: AddImageToProduct;
  ...
  beforeEach(async () => {
    ...
    addImageToProduct = module.get<AddImageToProduct>(AddImageToProduct);
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockProductService.addImageToProduct.mockResolvedValue(mockProductDTO);
