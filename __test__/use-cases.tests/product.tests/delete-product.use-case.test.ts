...
/**
 * Test suite for the DeleteProduct use case.
 * This test covers the initialization and behavior of the DeleteProduct class.
...
describe('DeleteProduct', () => {
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockProductService.deleteProduct.mockResolvedValue(mockProductDTO);
