...
/**
 * Test suite for the FetchFeaturedProducts use case.
 * This test covers the initialization and behavior of the FetchFeaturedProducts class.
...
describe('FetchFeaturedProducts', () => {
  let fetchFeaturedProducts: FetchFeaturedProducts;
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockProductService.fetchFeaturedProducts.mockResolvedValue(mockProductDTO);
    (toProductDTO as jest.Mock).mockReturnValue(mockProductDTO);

    // Execute the use case with provided parameters
    const result = await fetchFeaturedProducts.execute();

    // Verify that the service was called with the expected arguments
    expect(mockProductService.fetchFeaturedProducts).toHaveBeenCalledWith();
