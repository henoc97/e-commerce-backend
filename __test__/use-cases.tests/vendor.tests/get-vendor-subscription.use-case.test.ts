...
/**
 * Test suite for the GetVendorSubscription use case.
 * This test covers the initialization and behavior of the GetVendorSubscription class.
...
describe('GetVendorSubscription', () => {
  let getVendorSubscription: GetVendorSubscription;
  ...
  it('should create and return an address DTO', async () => {
    ...
    mockVendorService.getVendorSubscription.mockResolvedValue(mockVendorDTO);
