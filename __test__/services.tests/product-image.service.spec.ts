...
describe('ProductImageService', () => {
  ...
  it('should create product image', async () => {
    ...
    const returnOject: ProductImage = {
      id: 1,
      productId: 1,
      product: undefined,
      url: 'url',
  ...
  it('should throw an error when create product image method fails', async () => {
    ...
    mockProductImageRepository.create.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.createProductImage(imageDTO)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should get product image by id', async () => {
    ...
    const returnOject: ProductImage | null = {
      id: 1,
      productId: 1,
      product: undefined,
      url: 'url',
  ...
  it('should throw an error when get product image by id method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.getById.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.getProductImageById(id)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should update product image', async () => {
    ...
    expect(result).toEqual(returnOject);
    expect(mockProductImageRepository.update).toHaveBeenCalledWith(id, updates);
  });
  ...
  it('should throw an error when update product image method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.update.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.updateProductImage(id, updates)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should throw an error when delete product image method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.delete.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.deleteProductImage(id)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should get product images by product id', async () => {
    ...
    const returnOject: ProductImage[] = [
      { id: 1, productId: 1, product: undefined, url: 'url' },
    ];
    ...
    expect(result).toEqual(returnOject);
    expect(mockProductImageRepository.getByProductId).toHaveBeenCalledWith(
      productId,
    );
  });
  ...
  it('should throw an error when get product images by product id method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.getByProductId.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(
      service.getProductImagesByProductId(productId),
  ...
  it('should delete product images by product id', async () => {
    ...
    expect(result).toEqual(returnOject);
    expect(mockProductImageRepository.deleteByProductId).toHaveBeenCalledWith(
      productId,
    );
  });
  ...
  it('should throw an error when delete product images by product id method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.deleteByProductId.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(
      service.deleteProductImagesByProductId(productId),
    ).rejects.toThrow('Repository error');
  ...
  it('should throw an error when update product image url method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.updateUrl.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.updateProductImageUrl(id, url)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should does product image exist', async () => {
    ...
    expect(result).toEqual(returnOject);
    expect(mockProductImageRepository.exists).toHaveBeenCalledWith(
      productId,
      url,
    );
  });
  ...
  it('should throw an error when does product image exist method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.exists.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.doesProductImageExist(productId, url)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should get primary product image', async () => {
    ...
    expect(result).toEqual(returnOject);
    expect(mockProductImageRepository.getPrimaryImage).toHaveBeenCalledWith(
      productId,
    );
  });
  ...
  it('should throw an error when get primary product image method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.getPrimaryImage.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(service.getPrimaryProductImage(productId)).rejects.toThrow(
      'Repository error',
    );
  ...
  it('should count product images by product id', async () => {
    ...
    mockProductImageRepository.countImagesByProductId.mockResolvedValue(
      returnOject,
    );
    ...
    expect(result).toEqual(returnOject);
    expect(
      mockProductImageRepository.countImagesByProductId,
  ...
  it('should throw an error when count product images by product id method fails', async () => {
    ...
    // Simulate a failure when calling the repository
    mockProductImageRepository.countImagesByProductId.mockRejectedValue(
      new Error('Repository error'),
    );

    await expect(
      service.countProductImagesByProductId(productId),
    ).rejects.toThrow('Repository error');
